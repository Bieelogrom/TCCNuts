                ...
                <form action="#" class="sign-up-form">
                  ...
                  <div class="form-step form-step-active">
                    <div class="input-group">
                        <input type="text" name="username" id="username" placeholder="Usuária" >
                    </div>
                    <div class="input-group">
                        <input type="text" name="position" id="position" placeholder="Nome completo">
                    </div>
                    <div class="">
                  ...
                  <div class="form-step">
                    <div class="input-group">
                        <input type="date" name="dob" id="dob" placeholder="Data nascimento">
                    </div>
                    <div class="btns-group">
                        <a href="#" class="btn btn-prev">Anterior</a>
                        <a href="#" class="btn btn-next">Próximo</a>
