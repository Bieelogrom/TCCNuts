...
class usuarioDAO
{
    ...
    {
        try {
            $sql = "INSERT INTO tbusuario (nomeUsuario, telefoneUsuario, apelidoUsuario, emailUsuario, nascUsuario, senhaUsuario) VALUES (:nome, :phone, :apelido, :email, :dataNasc, :senha); ";
